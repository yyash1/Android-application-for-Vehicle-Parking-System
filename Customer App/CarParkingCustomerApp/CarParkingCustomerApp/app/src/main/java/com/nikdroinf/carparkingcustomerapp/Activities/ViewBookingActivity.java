...
public class ViewBookingActivity extends AppCompatActivity {
    ...
    private void getAllViewBooking() {
        ...
        client.post(Config.url_view_my_booking, params,new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    JSONArray jsonArray = response.getJSONArray("getViewMyBooking");
                    for (int i= 0 ; i<jsonArray.length(); i++)
                    {
                        JSONObject jsonObject = jsonArray.getJSONObject(i);
                        String book_vehincal_no = jsonObject.getString("book_vehicle_no");
                        ...
                        list.add(new pojo_View_Booking(book_vehincal_no,plot_name,slot_name,date_of_booking,time_of_booking));
                    }
