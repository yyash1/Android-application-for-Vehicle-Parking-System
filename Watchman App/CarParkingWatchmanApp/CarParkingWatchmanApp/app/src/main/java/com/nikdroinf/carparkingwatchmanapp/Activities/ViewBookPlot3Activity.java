...
public class ViewBookPlot3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_book_plot3);
    ...
    private void getAllBooking() {
        ...
        client.post(Config.url_get_booking, params, new JsonHttpResponseHandler() {
                    ...
                    public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i <jsonArray.length(); i++)
                            {
                                ...
                                if (plot_name.equals(plot3) && slot_name.equals(slot1))
                                {
                                    btn_slot1.setBackgroundColor(Color.RED);

                                }
                                else if (plot_name.equals(plot3) && slot_name.equals(slot2))
                                {
                                    btn_slot2.setBackgroundColor(Color.RED);
                                }
                                else if (plot_name.equals(plot3) && slot_name.equals(slot3))
                                {
                                    btn_slot3.setBackgroundColor(Color.RED);
                                }
                                else if (plot_name.equals(plot3) && slot_name.equals(slot4))
                                {
                                    btn_slot4.setBackgroundColor(Color.RED);
                                }
                                else if (plot_name.equals(plot3) && slot_name.equals(slot5))
                                {
                                    btn_slot5.setBackgroundColor(Color.RED);
                                }
                                else if (plot_name.equals(plot3) && slot_name.equals(slot6))
                                {
                                    btn_slot8.setBackgroundColor(Color.RED);
                                }
                                else if (plot_name.equals(plot3) && slot_name.equals(slot7))
                                {
                                    btn_slot7.setBackgroundColor(Color.RED);
                                }
                                else if (plot_name.equals(plot3) && slot_name.equals(slot8))
                                {
                                    btn_slot8.setBackgroundColor(Color.RED);
                                }
                                else if (plot_name.equals(plot3) && slot_name.equals(slot9))
                                {
                                    btn_slot9.setBackgroundColor(Color.RED);
                                }
                                else if (plot_name.equals(plot3) &&  slot_name.equals(slot10))
                                {
                    ...
                    public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                        Toast.makeText(ViewBookPlot3Activity.this, "Could Not Connect", Toast.LENGTH_SHORT).show();
                    }
                }
        );
    ...
    public void onBackPressed() {
        startActivity(new Intent(ViewBookPlot3Activity.this,ViewAvailablePlotActivity.class));
        finish();
    }
}
