...
public class ViewBookPlot2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_book_plot2);
    ...
    private void getAllBooking() {
        ...
        client.post(Config.url_get_booking, params, new JsonHttpResponseHandler() {
                    ...
                    public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i <jsonArray.length(); i++)
                            {
                                ...
                                else if (plot_name.equals(plot2) && slot_name.equals(slot9))
                                {
                                    btn_slot9.setBackgroundColor(Color.RED);
                                }
                                else if (plot_name.equals(plot2) &&  slot_name.equals(slot10))
                                {
                    ...
                    public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                        Toast.makeText(ViewBookPlot2Activity.this, "Could Not Connect", Toast.LENGTH_SHORT).show();
                    }
                }
        );
    ...
    public void onBackPressed() {
        startActivity(new Intent(ViewBookPlot2Activity.this,ViewAvailablePlotActivity.class));
        finish();
    }
}
