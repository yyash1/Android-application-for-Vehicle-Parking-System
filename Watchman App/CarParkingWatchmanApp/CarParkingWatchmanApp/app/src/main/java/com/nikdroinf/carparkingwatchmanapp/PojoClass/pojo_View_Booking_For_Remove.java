package com.nikdroinf.carparkingwatchmanapp.PojoClass;

public class pojo_View_Booking_For_Remove {

    String id,book_vehincal_no,plot_name,slot_name,date_of_booking,time_of_booking;

    public pojo_View_Booking_For_Remove(String id,String book_vehincal_no, String plot_name, String slot_name, String date_of_booking, String time_of_booking) {
        this.id = id;
