...
public class Plot3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plot3);
        ...
        btn_slot1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Plot3Activity.this,ConfirmBookSlotActivity.class);
                intent.putExtra("Slot",slot1);
                intent.putExtra("Plot",plot3);
    ...
    private void getAllBooking() {
        ...
        client.post(Config.url_get_booking, params, new JsonHttpResponseHandler() {
                    ...
                    public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                        Toast.makeText(Plot3Activity.this, "Could Not Connect", Toast.LENGTH_SHORT).show();
                    }
                }
        );
    }
    ...
    public void onBackPressed() {
        startActivity(new Intent(Plot3Activity.this, AvailablePlotActivity.class));
        finish();
    }
}
