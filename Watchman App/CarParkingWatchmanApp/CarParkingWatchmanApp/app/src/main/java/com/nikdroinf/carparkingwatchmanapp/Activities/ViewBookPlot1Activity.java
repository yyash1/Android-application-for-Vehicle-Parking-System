...
public class ViewBookPlot1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_book_plot1);
    ...
    private void getAllBooking() {
        ...
        client.post(Config.url_get_booking, params, new JsonHttpResponseHandler() {
                    ...
                    public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                        Toast.makeText(ViewBookPlot1Activity.this, "Could Not Connect", Toast.LENGTH_SHORT).show();
                    }
                }
        );
    }
    ...
    public void onBackPressed() {
        startActivity(new Intent(ViewBookPlot1Activity.this,ViewAvailablePlotActivity.class));
        finish();
    }
}
