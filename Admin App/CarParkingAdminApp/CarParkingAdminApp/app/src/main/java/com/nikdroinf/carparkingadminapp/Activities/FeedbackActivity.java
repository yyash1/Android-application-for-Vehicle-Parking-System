...
import com.nikdroinf.carparkingadminapp.Adapter.FeedbackAdapter;
...
public class FeedbackActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        lv_feedback = findViewById(R.id.lv_all_feedback);
...
//        params.put("election_state",preferences.getString("election_state",""));
        client.post(Config.url_all_feedback, params,new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    JSONArray jsonArray = response.getJSONArray("getAllFeedback");
                    for (int i= 0 ; i<jsonArray.length(); i++)
                    {
                        ...
                        list.add(new pojo_All_Feedback(vehical_no,mobile_no,feedback));
                    }

                    adapter = new FeedbackAdapter(list,FeedbackActivity.this,tv_no_record);
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                Toast.makeText(FeedbackActivity.this, "Could Not Connect", Toast.LENGTH_SHORT).show();
            }
        });
    }
